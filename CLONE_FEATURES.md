...
- `kiosk-idle-reset`: Auto-reset the viewer to the featured artifact and preset after a configurable idle period so unattended kiosks never freeze on obscure states.
